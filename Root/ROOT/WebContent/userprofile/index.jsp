        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    %>
                        <h1>Hello <%=registrationBean.getFirstname()%> </h1><br /><h3>Welcome to TRIVENI</h3>
                        <p>Welcome to Triveni - UNC Charlotte Indian Students Organization. <br />Please access your Dashboard to your left side </p>
