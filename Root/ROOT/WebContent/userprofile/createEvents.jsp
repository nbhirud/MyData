...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        %>
                       	...
                       	<form role="form" action="../AddEventsServlet" method="post">
							...
							<div class="form-group">
				                ...
				                <div class="input-group date form_date col-md-5" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
				                    <input class="form-control" size="16" type="text" required name="eventDate" readonly>
							...
							<div class="form-group">
							  ...
							  <input type="text" class="form-control" id="venue" required name="venue" placeholder="Enter Venue">
							</div>
							<div class="form-group">
							  <label for="description">Description</label>
							  <input type="text" class="form-control" id="description" required name="description" placeholder="Enter Venue">
							</div>
					        ...
					        <table class="table table-bordered">
					            ...
					            %>
					            	<tr>
						            	...
						            	<td><a href="updateEvents.jsp?id=<%=eventBean.getEventId()%>">Update</a>|
						            	<button class="btn btn-default" onclick="deleteEvent(<%=eventBean.getEventId()%>)">Delete</button></td>
					            	<tr>
					            <% } %>
					    		</tbody>
					    	</table>
    ...
    function deleteEvent(id){
    	$.post("../DeleteEventsServlet",{"id":id},function(info){
    		alert(info);
    		location.reload();
    	});
    }
