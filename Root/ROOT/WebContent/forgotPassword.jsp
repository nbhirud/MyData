        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li>
                        <a href="index.jsp#login">About</a>
                    </li>
	 ...
	 <div class="content-section-a" id="register">
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <p class="lead">Please enter the email that you have given during registration to get your password</p>
					 <form class="form-horizontal" action="ForgotPasswordServlet" method="post" role="form">
					  <div class="form-group">
					    <label class="control-label col-sm-2" for="email">Email:</label>
					    <div class="col-sm-10">
					      <input type="text"  id="email" name="email" placeholder="ex: gjohn">@uncc.edu
					    </div>
					  </div>
					  <div class="form-group">
